 ...
 * get you started.
 * 
 * @author mvail, mhthomas, awinters, Anton Leslie
 */
...
public class ListTester {
	...
	private void runTests() {
		...
		testEmptyList(A_iterRemove_emptyList, "A_iterRemove_emptyList");
		testEmptyList(A_listIterAfterRemoveA_emptyList, "A_listIterAfterRemoveA_emptyList");
		...
		testTwoElementList(B_addAfterAB_BA, "B_addAfterAB_BA", LIST_BA, STRING_BA);
		testTwoElementList(A_add0B_BA, "A_add0B_BA", LIST_BA, STRING_BA);
		testTwoElementList(B_add0A_AB, "B_add0A_AB", LIST_AB, STRING_AB);
		...
		testTwoElementList(A_listIterAddAAfterPreviousB_BA, "A_listIterAddAAfterPreviousB_BA", LIST_BA, STRING_BA);
		testTwoElementList(A_listIterAddBAfterNext_AB, "A_listIterAddBAfterNext_AB", LIST_AB, STRING_AB);
		testTwoElementList(A_listIterAddBAfterNewIterator_BA, "A_listIterAddBAfterNewIterator_BA", LIST_BA, STRING_BA);
		...
		testSingleElementList(AB_iterNextRemoveA_B, "AB_iterNextRemoveA_B", LIST_B, STRING_B);
		...
		testThreeElementList(AB_listIterAddCAfterPreviousB_ACB, "AB_addCafterPreviousB_ACB", LIST_ACB, STRING_ACB);
		...
		testTwoElementList(AB_listIteratorSetCAfterNextB_AC, "AB_listIteratorSetCAfterNextB_AC", LIST_AC, STRING_AC);
		testTwoElementList(AB_listIteratorSetCAfterPreviousA_CB, "AB_listIteratorSetCAfterPreviousA_CB", LIST_CB, STRING_CB);
		testTwoElementList(AB_listIteratorSetCAfterPreviousB_AC, "AB_listIteratorSetCAfterPreviousB_AC", LIST_AC, STRING_AC);
		//3-element to 2-element
		testTwoElementList(ABC_removeFirst_BC, "ABC_removeFirst_BC", LIST_BC, STRING_BC);
		testTwoElementList(ABC_remove2_AB, "ACB_remove2_AB", LIST_AB, STRING_AB);
		testTwoElementList(ABC_remove0_BC, "ABC_remove0_BC", LIST_BC, STRING_BC);
		testTwoElementList(ABC_iterNextRemoveA_BC, "ABC_iterNextRemoveA_BC", LIST_BC, STRING_BC);
		testTwoElementList(ABC_iterNextNextRemoveB_AC, "ABC_iterNextNextRemoveB_AC", LIST_AC, STRING_AC);
		testTwoElementList(ABC_iterNextNextNextRemoveC_AB, "ABC_iterNextNextNextRemoveC_AB", LIST_AB, STRING_AB);
		...
		testThreeElementList(ABC_listIterSetDAfterNextA_DBC, "ABC_listIteratorSetDAfterNextA_DBC", LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_listIterSetDAfterNextB_ADC, "ABC_listIteratorSetDAfterNextB_ADC", LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_listIterSetDAfterNextC_ABD, "ABC_listIterSetDAfterNextC_ABD", LIST_ABD, STRING_ABD);
		testThreeElementList(ABC_listIterSetDAfterPreviousA_DBC, "ABC_listIteratorSetDAfterPreviousA_DBC", LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_listIterSetDAfterPreviousB_ADC, "ABC_listIteratorSetDAfterPreviousB_ADC", LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_listIterSetDAfterPreviousC_ABD, "ABC_listIteratorSetDAfterPreviousC_ABD", LIST_ABD, STRING_ABD);
	...
	private IndexedUnsortedList<Integer> newList() {
		...
		switch (LIST_TO_USE) {
		/*
		 * case goodList: listToUse = new GoodList<Integer>(); break; case badList:
		 * listToUse = new BadList<Integer>(); break;
		 */
			//	case arrayList:
	...
	/** Scenario: [B] -> addAfter(A,B) -> [B,A] 
	 * @return [B,A] after addAfter(A,B)
	 */
	private IndexedUnsortedList<Integer> B_addAfterAB_BA() {
		IndexedUnsortedList<Integer> list = AB_removeFirst_B(); 
		list.addAfter(ELEMENT_A, ELEMENT_B);
		return list;
	}
	private Scenario<Integer> B_addAfterAB_BA = () -> B_addAfterAB_BA();
	...
	/** Scenario: [B] -> add(0,A) -> [A,B] 
	 * @return [A,B] after add(0,A)
	 */
	private IndexedUnsortedList<Integer> B_add0A_AB() {
		IndexedUnsortedList<Integer> list = A_set0B_B(); 
		list.add(0, ELEMENT_A);
		return list;
	}
	private Scenario<Integer> B_add0A_AB = () -> B_add0A_AB();
	...
	private IndexedUnsortedList<Integer> AB_removeFirst_B() {
		IndexedUnsortedList<Integer> list = B_addToFrontA_AB(); 
		list.removeFirst();
		return list;
	}
	private Scenario<Integer> AB_removeFirst_B = () ->  AB_removeFirst_B();

	/** Scenario: [AB] -> remove1 -> [A] 
	...
	/** Scenario: [AB] -> removeA -> [B] 
	 * @return [B] after removeA
	 */
	...
	private IndexedUnsortedList<Integer> BA_removeLast_B() {
		IndexedUnsortedList<Integer> list = B_add1A_BA(); 
		list.removeLast();
		return list;
	}
	private Scenario<Integer> BA_removeLast_B = () ->  BA_removeLast_B();

	/** Scenario: [BA] -> removeFirst -> [A] 
	...
	/** Scenario: [BA] -> remove1 -> [B] 
	 * @return [B] after remove1
	 */
	...
	/** Scenario: [BA] -> remove0 -> [A] 
	 * @return [A] after remove0
	 */
	...
	/** Scenario: [ABC] -> remove2 -> [AB] 
	 * @return [AB] after remove2
	 */
	...
	/** Scenario: [ABC] -> remove0 -> [BC] 
	 * @return [BC] after remove0
	 */
	...
	/** Scenario: [BC] -> addToFrontA -> [ABC] 
	 * @return [ABC] after addToFrontA
	 */
	...
	/** Scenario: [AB] -> addToRearC -> [ABC] 
	 * @return [ABC] after addToRearC
	 */
	 ...
	 */
	private IndexedUnsortedList<Integer> A_iterRemove_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_add0A_A(); 
	...
	private Scenario<Integer> A_iterRemove_emptyList = () -> A_iterRemove_emptyList();	
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_iterNextRemoveA_B() {
		IndexedUnsortedList<Integer> list = A_add1B_AB(); 
		Iterator<Integer> itt = list.iterator();
		itt.next();
		itt.remove();
	...
	private Scenario<Integer> AB_iterNextRemoveA_B = () -> AB_iterNextRemoveA_B();

	/** Scenario: [A, B, C] -> iterator remove() after next() returns A -> [B, C]
	 * @return [B, C] after iteratorRemove
	 */
	private IndexedUnsortedList<Integer> ABC_iterNextRemoveA_BC() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		Iterator<Integer> itt = list.iterator();
		itt.next();
		itt.remove();
	...
	private Scenario<Integer> ABC_iterNextRemoveA_BC = () -> ABC_iterNextRemoveA_BC();

	/** Scenario: [A,B,C] -> iterator remove() after 2xNext() returns B -> [A,C]
	 * @return [A, C] iterator remove() after 2xNext()
	 */
	private IndexedUnsortedList<Integer> ABC_iterNextNextRemoveB_AC() {
	...
	private Scenario<Integer> ABC_iterNextNextRemoveB_AC = () -> ABC_iterNextNextRemoveB_AC();

	/** Scenario: [A,B,C] -> iterator remove() after 3xNext() returns C -> [A,B]
	 * @return [A, B] after iterator remove() after 3xNext()
	 */
	private IndexedUnsortedList<Integer> ABC_iterNextNextNextRemoveC_AB() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		Iterator<Integer> itt = list.iterator();
		itt.next();
		itt.next();
	...
	private Scenario<Integer> ABC_iterNextNextNextRemoveC_AB = () -> ABC_iterNextNextNextRemoveC_AB();

	/** Scenario: [A] -> listIteratorAddB -> [B, A]
	 * @return [B, A] after listIteratorAddB
	 */
	 ...
	 * @return [C, B] listIteratorSetCAfterNextA
	 */
	private IndexedUnsortedList<Integer> AB_listIterSetCAfterNextA_CB() {
		IndexedUnsortedList<Integer> list = B_add0A_AB();
		ListIterator<Integer> itt = list.listIterator();
		itt.next();
		itt.set(ELEMENT_C);
		return list;
	}
	...
	/**
	 * Scenario: [A, B] -> listIteratorSetCAfterNextB -> [AC]
	 * @return [A, C] after listIteratorSetCAfterNextB
	 */
	private IndexedUnsortedList<Integer> AB_listIteratorSetCAfterNextB_AC() {
		IndexedUnsortedList<Integer> list = A_add1B_AB();
	...
	private Scenario<Integer> AB_listIteratorSetCAfterNextB_AC = () -> AB_listIteratorSetCAfterNextB_AC();

	/**
	 * Scenario: [A, B] -> listIteratorSetCAfterPreviousA -> [C, B]
	 * @return [C, B] after listIteratorSetCAfterPreviousA
	 */
	private IndexedUnsortedList<Integer> AB_listIteratorSetCAfterPreviousA_CB() {
		IndexedUnsortedList<Integer> list = A_add1B_AB();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIteratorSetCAfterPreviousA_CB = () -> AB_listIteratorSetCAfterPreviousA_CB();

	/**
	 * Scenario: [A, B] -> listIteratorSetCAfterPreviousB -> [A, C]
	 * @return [A, C] after listIteratorSetCAfterPreviousB
	 */
	private IndexedUnsortedList<Integer> AB_listIteratorSetCAfterPreviousB_AC() {
		IndexedUnsortedList<Integer> list = A_add1B_AB();
	...
	private Scenario<Integer> AB_listIteratorSetCAfterPreviousB_AC = () -> AB_listIteratorSetCAfterPreviousB_AC();
	...
	private IndexedUnsortedList<Integer> emptyList_listIterAddA_A() {
		IndexedUnsortedList<Integer> list = A_removeLast_emptyList();
		ListIterator<Integer> itt = list.listIterator();
		itt.add(ELEMENT_A);
		return list;
	}
	 ...
	 * @return [A, D, C] after listIteratorAddDAfterNextB
	 */
	...
	/** Scenario: [A] -> listIteratorAddAAfterPreviousB -> [B, A]
	 * @return [B, A] after listIteratorAddAAfterPreviousB
	 */
	private IndexedUnsortedList<Integer> A_listIterAddAAfterPreviousB_BA() {
	...
	private Scenario<Integer> A_listIterAddAAfterPreviousB_BA = () -> A_listIterAddAAfterPreviousB_BA();

	/** Scenario: [A, B] -> listIteratorRemoveAfterPrevious -> [B]
	 * @return [B] after listIteratorRemoveAfterPrevious
	 */
	...
	/** Scenario: [A] -> listIteratorAfterRemoveA -> []
	 * @return [] after listIteratorAfterRemoveA
	 */
	private IndexedUnsortedList<Integer> A_listIterAfterRemoveA_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_add0A_A();
		ListIterator<Integer> itt = list.listIterator();
		itt.next();
		itt.remove();
	...
	private Scenario<Integer> A_listIterAfterRemoveA_emptyList = () -> A_listIterAfterRemoveA_emptyList();
	...
	/** Scenario: [A] -> listIteratorAddBAfterNext -> [A, B]
	 * @return [A, B] after listIteratorAddBAfterNext
	 */
	...
	/** Scenario: [A] -> listIteratorAddBAfterNewIterator -> [B, A]
	 * @return [B, A] after listIteratorAddBAfterNewIterator
	 */
	private IndexedUnsortedList<Integer> A_listIterAddBAfterNewIterator_BA() {
		IndexedUnsortedList<Integer> list = emptyList_add0A_A();
		ListIterator<Integer> lit = list.listIterator();
		lit.add(ELEMENT_B);
		return list;
	}
	private Scenario<Integer> A_listIterAddBAfterNewIterator_BA = () -> A_listIterAddBAfterNewIterator_BA();
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		// IndexedUnsortedList
					...
					printTest(scenarioName + "_iterNextNextRemove_testIterNext", testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), contents[1], Result.NoSuchElement));
